...
<table class="table">
    ...
    <tr>
        ...
        <td> <a type="button" class="btn btn-danger"  onclick="return confirm('Do you want to delete?')" href="/hoa-don/delete/${hd.id}" >Delete</a></td>
        <td><a type="button" class="btn btn-success" href="/hoa-don/details/${hd.id}">Details</a></td>
        <td><a type="button" class="btn btn-primary" href="/hoa-don/view-update/${hd.id}">Update</a></td>
    </tr>
    </c:forEach>
    </tr>
</table>
